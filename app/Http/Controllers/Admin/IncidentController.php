...
class IncidentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'incident_history' => 'required|array',
            'incident_history.incident_date' => 'required|date',
            'incident_history.driver_id' => 'nullable',
            'incident_history.place' => 'required|string',
            'incident_history.police_station' => 'string',
            'incident_history.summary' => 'required|string',
            'incident_history.have_police_conclusion' => 'required|boolean',
            'incident_history.police_conclusion' => 'nullable|string',
            'incident_history.workshop_id' => 'nullable',
            'incident_history.workshop_entrance_date' => 'required|date',
            'incident_history.budget_approval_date' => 'required|date',
            'incident_history.executive_id' => 'nullable',
            'incident_history.is_bank_endorsed' => 'required|boolean',
