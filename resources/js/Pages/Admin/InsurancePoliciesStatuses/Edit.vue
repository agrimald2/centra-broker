        ...
        <div class="relative max-w-xl max-h-full m-auto" style="min-width: 30%;">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Editar Estado de Póliza </h3>
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" id="name" v-model="insurance_policies_status.name"
                        ...
                        <button type="button" @click="submit"
                            ...
                            <span v-if="insurance_policies_status.deleted_at">
                                {{ insurance_policies_status.deleted_at ? 'Restaurar' : 'Editar' }}
                            </span>
                            <span v-else>
                                Editar
                            </span>
...
export default {
    components: {},
    props: ['id', 'insurance_policies_status'],
    data() {
        return {
            insurance_policies_status: this.insurance_policies_status
        };
    },
    methods: {
        async submit() {
            try {
                const response = await axios.put('/admin/insurance_policies_statuses/' + this.insurance_policies_status.id, this.insurance_policies_status);
