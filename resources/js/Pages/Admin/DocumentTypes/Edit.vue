        ...
        <div class="relative max-w-xl max-h-full m-auto" style="min-width: 30%;">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Editar Tipo de Documento </h3>
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" id="name" v-model="document_type.name"
                        ...
                        <button type="button" @click="submit"
                            ...
                            <span v-if="document_type.deleted_at">
                                {{ document_type.deleted_at ? 'Restaurar' : 'Editar' }}
                            </span>
                            <span v-else>
                                Editar
                            </span>
...
export default {
    ...
    methods: {
        async submit() {
            try {
                const response = await axios.put('/admin/document_types/' + this.document_type.id, this.document_type);
