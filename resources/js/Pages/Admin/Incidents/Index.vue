        ...
        <div class="shadow-md sm:rounded-lg relative">
            <div class="px-2 flex items-center justify-between py-4 bg-white ">
                ...
                <div class="flex items-center">
                    <div class="relative w-full">
                        ...
                        <input type="text" id="simple-search" v-model="search" @input="fetchIncidents"
                ...
                <a href="/admin/insurance_policies/create"
                    ...
                    <span class="hidden md:flex"> Nuevo Siniestro </span>
                    <i class="fa-solid fa-car-burst text-xl"></i>
                </a>
                -->
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500  table" v-if="incidents">
                    ...
                    <tbody>
                        <tr v-for="incident in incidents" class="bg-white border-b   hover:bg-gray-50 ">
                            <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap ">
                                <div class="">
                                    <div class="text-base font-semibold"> <a
                                            :href="`/admin/insurance_policies/show/${incident.asset.insurance_policy_data.insurance_policy.id}`">
                                            {{ incident.asset.insurance_policy_data.insurance_policy.number }}</a></div>
                                    <div class="font-normal text-gray-500  hidden sm:flex"></div>
                                </div>
                            </th>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                {{ incident.asset.asset_type.name }} <br>
                                $ {{ incident.asset.insured_amount }}
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
            ...
            <nav class="flex items-center justify-between p-4" aria-label="Table navigation">
                <span class="text-sm font-normal text-gray-500 ">
                    <span class="font-semibold text-gray-900 ">1 a 10</span> de
...
export default {
    ...
    methods: {
        ...
        async fetchIncidents() {
            this.loading = true;
            try {
                const response = await axios.get('/admin/incidents/filter', {
                    params: {
                        search: this.search,
                    },
                });
