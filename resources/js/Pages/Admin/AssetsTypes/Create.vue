        ...
        <div class="relative max-w-xl max-h-full m-auto" style="min-width: 30%;">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Crear Tipo de Activo</h3>
                    <div class="space-y-6">
                        <div>
...
export default {
    ...
    methods: {
        async submit() {
            try {
                const response = await axios.post('/admin/assets_types', this.formData);
