        ...
        <div class="relative max-w-xl max-h-full m-auto" style="min-width: 30%;">
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 ">Añadir Atributo a {{ assets_type.name
                    }}</h3>
                    <div class="space-y-6">
                        <div>
                        ...
                        <div>
                            <label for="type"
                                class="block mb-2 text-sm font-medium text-gray-900 ">Tipo</label>
                            <select id="type" name="type" v-model="formData.input_type"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" id="name" v-model="formData.description"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5    dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="John Doe">
                            </div>
                        </div>
                        <div>
                            <label for="example" class="block mb-2 text-sm font-medium text-gray-900 ">
                                Ejemplo
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                                ...
                                <input type="text" name="name" id="name" v-model="formData.example"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5    dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="John Doe">
                            </div>
                        </div>
...
export default {
    components: {},
    props: ['id', 'assets_type'],
    data() {
        return {
            formData: {
                assets_type_id: this.assets_type.id,
                name: '',
                input_type: 'text',
                description: '',
                example: ''
    ...
    methods: {
        async submit() {
            try {
                const response = await axios.post('/admin/add_assets_type_attribute', this.formData);
