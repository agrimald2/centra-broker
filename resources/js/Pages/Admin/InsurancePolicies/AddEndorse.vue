                    ...
                    <form class="px-2">
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                <h2 class="text-base font-semibold leading-7 text-gray-900">{{ 'Póliza N°' +
                                    insurancePolicy.insurance_policy.number }}
                                </h2>
                                <pre>
                                    {{insurancePolicy.insurance_policy.number}}
                                </pre>
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <span class="flex select-none items-center pl-3 text-gray-500 sm:text-sm">N°
                                                    | </span>
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <v-select v-model="insurance_policy.insurance_policy_data.customer_id"
                                                :options="customers" disabled :reduce="customer => customer.id"
                                                label="name"></v-select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <v-select v-model="insurance_policy.insurance_policy_data.insurance_company_id"
                                                disabled :options="insurance_companies"
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-4">
                                            <div class="relative">
                                                ...
                                                <input type="date"
                                                    v-model="insurance_policy.insurance_policy_data.start_date" disabled
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <input type="number" name="number" id="number" autocomplete="number"
                                                    disabled v-model="insurance_policy.insurance_policy_data.comission"
                                                    class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                                    placeholder="12.0">
                                            </div>
                                        </div>
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <div class="mt-5">
                                            <div
                                                ...
                                                <input type="number"
                                                    v-model="insurance_policy.insurance_policy_data.risk_rate" disabled
                                                    class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                                    placeholder="2.8">
                                            </div>
                                        </div>
