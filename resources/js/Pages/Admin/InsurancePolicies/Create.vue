        ...
        <form class="px-2">
            <div class="space-y-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">
                                Responsable de pago
                                <!-- Add People Modal-->
                                <button type="button" @click="showModal('AddBillingContact')"
                                    class="ml-2 text-white bg-green-800 hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-2 py-2 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 mr-2 mb-2">
                                    <i class="fa-solid fa-user-plus font-xl"></i>
                                </button>
                            ...
                            <div class="mt-2">
                                ...
                                <input type="text" placeholder="Responsable de pago" disabled
                                    v-model="this.insurance_policy.insurance_policy_data.insurance_policy_billing_contact.name"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <ul class="m-auto divide-y divide-gray-200 bg-white border border-gray-200 rounded-lg ">
                                    <li v-for="people_in_insurance in this.insurance_policy.insurance_policy_data.insurance_policy_insuranced_people"
                                ...
                                <div class="sm:col-span-3">
                                    <div class="mt-2">
                                        <select id="country" name="country" autocomplete="country-name"
                                            v-model="this.insurance_policy.insurance_policy_data.comission_type_id"
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="number" name="number" id="number" autocomplete="number"
                                        v-model="this.insurance_policy.insurance_policy_data.comission"
                                        class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="12.0">
                                </div>
                            </div>
                        ...
                        <div class="sm:col-span-1 col-span">
                            ...
                            <div class="mt-5">
                                <div
                                    ...
                                    <input type="number"
                                        v-model="this.insurance_policy.insurance_policy_data.number_of_installments"
                                        class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="5">
                                </div>
                            </div>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <div class="mt-5">
                                <div
                                    ...
                                    <input type="number" v-model="this.insurance_policy.insurance_policy_data.risk_rate"
                                        class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="2.8">
                                </div>
                            </div>
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="sm:col-span-3">
                        <div class="mt-10 grid grid-cols-8  gap-y-4">
                            <div v-for="asset in this.insurance_policy.insurance_policy_data.assets"
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="sm:col-span-3">
                        <div class="mt-10 grid grid-cols-8 gap-y-4">
                            <div v-for="file in this.insurance_policy.insurance_policy_data.files"
        ...
        return {
            insurance_policy: {
                ...
                insurance_policy_data: {
                    ...
                    end_date: null,
                    comission_type_id: 1,
                    comission: this.general_settings.comission,
