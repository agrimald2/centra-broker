...
export default {
    ...
    props: ['customers', 'customer_types', 'document_types', 'breadcrumbs'],
    data() {
        return {
            search: '',
            customerTypeFilter: '',
    ...
    methods: {
        ...
        async fetchCustomers() {
            try {
                const response = await axios.get('/admin/customerFilter', {
                    params: {
                        search: this.search,
                        customer_type_id: this.customerTypeFilter,
                        document_type_id: this.documentTypeFilter,
                    },
                });
    ...
    watch: {
        ...
        customerTypeFilter: 'fetchCustomers',
        documentTypeFilter: 'fetchCustomers',
    },
};
</script>
